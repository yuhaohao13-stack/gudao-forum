        ...
        <div className="flex items-center justify-between pb-3 gap-1 overflow-x-auto scrollbar-none">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <a href="https://v.douyin.com/NvUr5C82ZDM/" target="_blank" rel="noopener"
              className="flex items-center gap-1 whitespace-nowrap text-xs sm:text-sm font-bold px-2 sm:px-3 py-1.5 rounded-full bg-gradient-to-r from-[#00f2fe] to-[#fe2c55] text-white hover:opacity-90 transition-all shadow-sm"
            ...
            <a href="https://www.crazy-repair.com" target="_blank" rel="noopener" className="whitespace-nowrap text-xs sm:text-sm font-semibold px-3 sm:px-4 py-1.5 rounded-full text-white bg-gradient-to-b from-[#4a8eff] to-[#2563eb] shadow-md hover:shadow-lg hover:from-[#5b98ff] hover:to-[#3b82f6] transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0.5 active:shadow-sm">crazy 维修</a>
          </div>
