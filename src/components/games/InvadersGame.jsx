      ...
      {state === 'playing' && (
        <div className="w-full sm:max-w-lg">
          <div className="flex gap-[32px]">
            <button className="flex-1 h-[48px] text-[36px] font-bold bg-white border-2 border-[#ddd] rounded-2xl active:bg-[#eee] shadow-lg touch-manipulation"
            ...
            >◀ 左</button>
            <button className="flex-1 h-[48px] text-[36px] font-bold bg-red-50 border-2 border-[#f00] rounded-2xl active:bg-[#ffe0e0] shadow-lg touch-manipulation"
