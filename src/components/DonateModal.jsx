...
export default function DonateModal() {
  const { showModal, showPayNowQR, setShowPayNowQR, closeAll, toast, showToast } = useDonate()
  ...
  return (
    <>
      ...
      {/* Toast */}
      {toast && (
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-[220] bg-[#1a1a1a] text-white text-[11px] px-4 py-2 rounded-full shadow-lg anim-fade-in">
          {toast}
        </div>
      )}
    </>
