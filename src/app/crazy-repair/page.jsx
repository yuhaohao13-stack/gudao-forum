        ...
        <div className="bg-white rounded-xl p-6 sm:p-8 shadow-sm border border-gray-100">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            ...
            <div className="flex flex-col gap-2 text-sm">
              <div className="inline-flex items-center gap-2 px-4 py-2.5 bg-green-50 text-green-800 rounded-lg">
                💚 微信 <span className="font-mono">{'crazy-repair'}</span>
              </div>
              <div className="inline-flex items-center gap-2 px-4 py-2.5 bg-red-50 text-red-800 rounded-lg">
                📧 QQ <span className="font-mono">{'994730969@qq.com'}</span>
              </div>
              <div className="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-50 text-blue-800 rounded-lg">
                📧 Google <span className="font-mono">{'yuhaohao13@gmail.com'}</span>
              </div>
              <a href="https://www.crazy-repair.com" target="_blank" rel="noopener"
                className="inline-flex items-center gap-2 px-4 py-2.5 bg-amber-50 text-amber-800 rounded-lg hover:bg-amber-100 transition-colors">
                🌐 访问官网 crazy-repair.com <ExternalLink size={14} />
              </a>
            </div>
          </div>
        </div>
