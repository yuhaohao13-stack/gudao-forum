...
function Results() {
  ...
  return (
    <div className="anim-fade-in max-w-3xl mx-auto">
      <h1 className="text-xl font-bold text-[#1c1917] mb-5">搜索</h1>
      ...
      {loading && <div className="flex justify-center py-8"><div className="w-5 h-5 border-[1.5px] border-[#ddd] border-t-[#1c1917] rounded-full animate-spin" /></div>}
...
export default function SearchPage() {
  return <Suspense fallback={<div className="flex justify-center py-20"><div className="w-5 h-5 border-[1.5px] border-[#ddd] border-t-[#1c1917] rounded-full animate-spin" /></div>}><Results /></Suspense>
}
