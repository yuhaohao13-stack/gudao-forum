...
export default function CategoryPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <Link href="/" className="text-sm text-blue-400 hover:underline">&larr; 返回首页</Link>
      ...
      <Link
        href="/new-thread"
        className="inline-block bg-blue-600 hover:bg-blue-500 px-4 py-2 rounded-lg text-sm font-semibold transition-colors mb-4"
      >
        ✏️ 发新帖
      </Link>
