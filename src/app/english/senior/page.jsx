...
export default function SeniorOverviewPage() {
  ...
  useEffect(() => { document.title = '高中词汇与语法 — 古道论坛' }, [])
    ...
    <div className="anim-fade-in max-w-2xl mx-auto pb-6">
        ...
        <Link href="/english/senior/vocab" className="block group">
          <div className="bg-white border border-[#ece8e0] rounded-xl p-4 hover:border-amber-400/40 hover:shadow-sm transition-all">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-50 to-yellow-100 flex items-center justify-center text-lg shrink-0 border border-amber-200">
                📖
              </div>
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-[#999]">大學學測4000字+指考7000字 · {SENIOR_VOCAB.length}词 · 每页50词</p>
              </div>
      ...
      <GoldLock previewLines={5}>
        ...
        <div className="bg-white border border-[#ece8e0] rounded-xl overflow-hidden shadow-sm mb-4">
          <div className="px-4 py-3 bg-gradient-to-r from-amber-50 to-yellow-50 border-b border-[#ece8e0]">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="bg-[#faf8f5] rounded-lg px-3 py-2">
                    ...
                    <p className="text-[10px] text-[#888]">薄冰著 · 中国语法教学泰斗，体系最完整</p>
                  </div>
                  <div className="bg-[#faf8f5] rounded-lg px-3 py-2">
                    <p className="text-[11px] font-medium text-[#1c1917]">2. 《张道真实用英语语法》</p>
                    <p className="text-[10px] text-[#888]">张道真著 · 例句丰富，适合查漏补缺</p>
                  </div>
                  <div className="bg-[#faf8f5] rounded-lg px-3 py-2">
