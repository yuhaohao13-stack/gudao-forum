...
export default function DeepSeekChatPage() {
  ...
  useEffect(() => {
    document.title = 'DeepSeek V4 Flash 在线对话 — 古道论坛 AI 智能工具箱'
    let meta = document.querySelector('meta[name="description"]')
    if (!meta) { meta = document.createElement('meta'); meta.name = 'description'; document.head.appendChild(meta) }
    meta.content = '古道论坛DeepSeek V4 Flash在线AI对话，深度推理模型，擅长逻辑分析、代码编写、多轮对话。黄金会员100次/钻石会员1000次。'
    ...
    meta.content = 'DeepSeek V4,深度推理,AI对话,在线DeepSeek,AI代码生成,逻辑分析,古道论坛,AI工具箱'
  }, [])
  ...
  return (
    <div className="max-w-3xl lg:max-w-lg mx-auto px-3 sm:px-4 py-4 sm:py-6">
      {/* 顶栏 */}
      ...
      {/* 聊天区 */}
      <div className="bg-white border border-[#ece8e0] rounded-xl overflow-hidden flex flex-col" style={{ height: '53vh', minHeight: '300px' }}>
