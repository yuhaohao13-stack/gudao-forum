  ...
  return (
    <div className="anim-fade-in max-w-2xl mx-auto">
      ...
      <div className="bg-white border border-[#ece8e0] rounded-xl px-5 py-6 sm:px-8 sm:py-8 mb-4">
        {/* Idiom name - large display */}
        <h1 className="text-2xl sm:text-3xl font-bold text-center text-[#b45309] tracking-wide mb-2">
          {item.idiom}
        </h1>

        {/* Pinyin hint with id number */}
        <p className="text-center text-[10px] text-[#b0a898] mb-3">
          #{item.id}
        </p>

        {/* Meaning */}
        <div className="flex justify-center mb-5">
          <span className="inline-block px-3 py-1 rounded-full bg-amber-50 text-[#b45309] text-xs font-medium border border-amber-200">
            {item.meaning}
          </span>
        </div>
