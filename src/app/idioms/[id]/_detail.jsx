        ...
        <div className="bg-white border border-[#ece8e0] rounded-xl px-5 py-12 sm:px-8 text-center">
          ...
          <div className="relative mb-6 text-left overflow-hidden max-h-56">
            <div className="space-y-3">
              <p className="text-sm leading-relaxed text-[#2a2a2a]"><span className="text-[#b45309] font-medium">【释义】</span>{item.meaning}</p>
              <p className="text-sm leading-relaxed text-[#555]">{item.story.slice(0, 400)}{item.story.length > 400 ? '……' : ''}</p>
            </div>
